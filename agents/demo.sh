...
echo ""
echo "Watch and listen:"
echo "  👁️  GUI: Agent tapping cells, dialogs opening"
echo "  👁️  GUI: TalkBack announcements (bottom of screen)"
echo "  👁️  GUI: Numbers being entered in cells"
echo "  🔊 AUDIO: Hear TalkBack speaking the announcements!"
echo ""
